...
SERVICE_ACCOUNT_FILE = "/home/user_name/credentials.json"  # Replace with the path to your downloaded credentials file
SPREADSHEET_ID = 'your_spreadsheet_id'  # Replace with your Google Spreadsheet ID

# Load credentials and create a Google Sheets API client
...
# Your list of cities here (truncated for brevity)
cities = [
    ...
    for city in cities:
        try:
            ...
            if response.status_code == 200:
                ...
                if "list" in data:
                    # Your data extraction logic here (unchanged)
